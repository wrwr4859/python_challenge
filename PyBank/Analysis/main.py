...
index_max = average_change_list2.index(max(average_change_list2))
index_min = average_change_list2.index(min(average_change_list2))
...
print("Greatest Increase in Profits: " + months[index_max+1] + " ($" + str(max(average_change_list2)) + ")")
print("Greatest Decrease in Profits: " + months[index_min+1] + " ($" + str(min(average_change_list2)) + ")")
...
f.write("\nGreatest Increase in Profits: " + months[index_max+1] + " ($" + str(max(average_change_list2)) + ")")
f.write("\nGreatest Decrease in Profits: " + months[index_min+1] + " ($" + str(min(average_change_list2)) + ")")
f.close()
